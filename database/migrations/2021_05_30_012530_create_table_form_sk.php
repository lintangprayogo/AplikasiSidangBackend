...
class CreateTableFormSk extends Migration
{
    ...
    public function up()
    {
        Schema::create('form_sk', function (Blueprint $table) {
            ...
            $table->string('judul_indonesia_new')->nullable();
            $table->string('judul_inggris_new')->nullable();
            $table->string('alasan');
            $table->string('jenis');
            $table->string('sk_ta_lama');
            $table->string('persetujuan_pembimbing_1')->default("PENDING");
            $table->string('persetujuan_pembimbing_2')->nullable();
            $table->string('persetujuan_pembimbing_new_1')->nullable();
            $table->string('persetujuan_pembimbing_new_2')->nullable();
