    ...
    */
    public function view(): View
    {
      ...
      foreach ($sidangs as $sidang){
         ...
         $sidang->nilai_penguji_1,$sidang->nilai_penguji_2,$jml_pembimbing,$jml_penguji);
    ...
    if($jml_pembimbing==0){
    ...
    else if ($nilai_pembimbing2_laporan && $nilai_pembimbing1_laporan) {
        $ra_laporan =
      ...
      else if ($nilai_pembimbing1_presentasi && $nilai_pembimbing2_presentasi) {
        $ra_presentasi =
      ...
      if($jml_pembimbing==0){
        $ra_produk=0;
      }else if ($nilai_pembimbing1_produk && $nilai_pembimbing2_produk) {
        $ra_produk =
      ...
      else if ($nilai_penguji2_laporan && $nilai_penguji1_laporan) {
        $rb_laporan =
      ...
      else if ($nilai_penguji1_presentasi && $nilai_penguji2_presentasi) {
        $rb_presentasi =
      ...
      else if ($nilai_penguji1_produk && $nilai_penguji2_produk) {
        $rb_produk =
